...
public class SystemUserMultipleSUBISORegression {
	...
	public SystemUserMultipleSUBISORegression() throws InterruptedException {
...
//		 this.driver = driver;
	...
	public void SystemMakerClicktheBankModule() {
		...
		try {
			BL.clickElement(B.ClickOnSUBISO);
		} catch (Exception e) {
	...
	@Then("the System Maker SUB ISO Onboarding should prompt users to enter valid inputs using the sheet name {string}")
...
//				"Bank Module Click");
	...
	private void fillSalesInfo(Map<String, String> testData, int TestcaseNo) throws Exception {
		try {
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Create : ", "SUB-ISO", CreateStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Sales Info : ISO Appliction Date", "Current Date", DateStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Sales Info : Agreement Date", "Current Date", DateStatus, errorMessage);
			...
			if (name != null && !name.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Sales Info : Aggregator Name", name, nameStatus, errorMessage);
			...
			if (isoname != null && !isoname.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Sales Info : ISO Name", isoname, nameStatus, errorMessage);
...
//				logInputData("Marsid", Marsid);
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Sales Info : Marsid :", Marsid, MarsidStatus, errorMessage);
		...
		try {
			...
			if (LegalName != null && !LegalName.trim().isEmpty()) {
				...
				try {
					...
					BL.isElementNotDisplayed(A.CompanyLegalNameFieldisRequired, "Field is Required");				} catch (AssertionError e) {
					legalNameStatus = false; // Set status to false if assertion fails
					errorMessage = e.getMessage(); // Capture error message
				}

				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Legal Name", LegalName, legalNameStatus, errorMessage);
			...
			if (brand != null && !brand.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Brand Name", brand, Status, errorMessage);
			...
			if (Address != null && !Address.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Registered Address", Address, Status, errorMessage);
			...
			if (pincode != null && !pincode.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Registered Pincode", pincode, Status, errorMessage);
			...
			if (type != null && !type.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Business Type", type, Status, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Established Year", "Current Date", DateStatus, errorMessage);
...
//				registeredNumber = String.format("%.0f", numberInScientificNotation);
			...
			if (registeredNumber != null && !registeredNumber.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Registered Number", registeredNumber, Status, errorMessage);
			...
			if (pan != null && !pan.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info :Company PAN", pan, Status, errorMessage);
			...
			if (GstIN != null && !GstIN.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : GstIN", GstIN, Status, errorMessage);
			...
			if (frequency != null && !frequency.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info :Statement Frequency", frequency, Status, errorMessage);
			...
			if (Type != null && !Type.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Statement Type", Type, Status, errorMessage);
			...
			if (domain != null && !domain.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Domain", domain, Status, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info :Save Button", "Company Info", SaveStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info :","NextStep", NextstepStatus, errorMessage);
	...
	private void fillPersonalInfo(Map<String, String> testData, int TestcaseNo) throws Exception {
		try {
			...
			if (title != null && !title.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Company Info : Title", title, Status, errorMessage);
			...
			if (FirstName != null && !FirstName.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : FirstName", FirstName, Status, errorMessage);
			...
			if (LastName != null && !LastName.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : LastName", LastName, Status, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Date Of Birth", "30/11/1998", DateStatus, errorMessage);
			...
			if (pan != null && !pan.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Pan", pan, Status, errorMessage);
			...
			if (Address != null && !Address.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Address", Address, Status, errorMessage);
			...
			if (pincode != null && !pincode.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Pincode", pincode, Status, errorMessage);
			...
			if (PMobilenumber != null && !PMobilenumber.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Mobilenumber", Mobilenumber, Status, errorMessage);
			...
			if (telephone != null && !telephone.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Telephone Number", telephone, Status, errorMessage);
			...
			if (emailid != null && !emailid.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Emailid", emailid, Status, errorMessage);
			...
			if (Nationality != null && !Nationality.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Nationality", Nationality, Status, errorMessage);
			...
			if (aadhaar != null && !aadhaar.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Aadhaar", aadhaar, Status, errorMessage);
			...
			if (Passport != null && !Passport.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Passport", Passport, Status, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Date ", "Passport ExpiryDate", DateStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info : Save Button", "Personal Info", SaveStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Personal Info :" , " NextStep ",  NextstepStatus, errorMessage);
	...
	private void fillCommunicationDetailsAdminUserDetails(Map<String, String> testData, int TestcaseNo)
		...
		try {
			...
			if (CommName != null && !CommName.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : Admin user details Communication Name", CommName, CommunicationNameStatus,
						errorMessage);
			...
			if (CommPosition != null && !CommPosition.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : Admin user details Communication Position", CommPosition,
			...
			if (CommMobileNumber != null && !CommMobileNumber.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : Admin user details Communication MobileNumber", communicationMobileNumber,
			...
			if (CommEmailid != null && !CommEmailid.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : Admin user details Communication Emailid", Communicationemailid,
			...
			if (ADUSer != null && !ADUSer.trim().isEmpty()) {
				...
				try {
					...
					BL.isElementNotDisplayed(B.CommunicationUserNameInvalidFormat, "Invalid Format");
					BL.isElementNotDisplayed(B.CommunicationUserNameFieldisRequired, "Field is Required");
				} catch (AssertionError e) {
					CommunicationADUSERStatus = false;
					errorMessage = e.getMessage(); // Capture error message
				}
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : Admin user details AD User", ADUSer, CommunicationADUSERStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : Admin user details Save Button", "Communication Info", SaveStatus, errorMessage);
	...
	private void fillCommunicationDetailsSettlementReconContactDetails(Map<String, String> testData, int TestcaseNo)
		...
		try {
			...
			if (CommName != null && !CommName.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : SettlementReconContactDetails Communication Name", CommName,
			...
			if (CommPosition != null && !CommPosition.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : SettlementReconContactDetails Communication Position", CommPosition,
						CommunicationPositionStatus, errorMessage);
			...
			if (CommMobileNumber != null && !CommMobileNumber.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : SettlementReconContactDetails Communication MobileNumber",
			...
			if (CommEmailid != null && !CommEmailid.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : SettlementReconContactDetails Communication Emailid", Communicationemailid,
						CommunicationEmailIDStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info : SettlementReconContactDetails Save Button", "Communication Info", SaveStatus,
					errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Communication Info :","NextStep", NextstepStatus, errorMessage);
		...
		try {
			...
			for (int currentRow = 1; currentRow <= numberOfRows; currentRow++) {
				...
				if (!channel.isEmpty()) {
					...
					testcaseCount++;
					logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : ChannelConfig : Channel", channel, channelStatus, errorMessage);
				...
				if (!network.isEmpty()) {
					...
					testcaseCount++;
					logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : ChannelConfig : Network", network, networkStatus, errorMessage);
				...
				if (!transactionSet.isEmpty()) {
					...
					testcaseCount++;
					logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : ChannelConfig : TransactionSet", transactionSet, transactionSetStatus, errorMessage);
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : ChannelConfig : Start Date", "Valid Date", DateStatus, errorMessage);
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : ChannelConfig : END Date", "Valid Date", DateStatus, errorMessage);
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : ChannelConfig : Save Button", "Channel Config", saveStatus, errorMessage);
			}
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : ChannelConfig : ","NextStep",  nextStepStatus, errorMessage);
	...
	private void fillKYCDetails(Map<String, String> testData, int TestcaseNo)
		...
		try {
			...
			if (poAImage != null && !poAImage.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : KYC : KYC Details", poAImage, Status, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : KYC : ","NextStep", nextStepStatus, errorMessage);
	...
	private void FillDiscountRate(Map<String, String> testData, int TestcaseNo)
		...
		try {
			...
			// Load cached data for "Channel Bank" sheet
			List<Map<String, String>> cachedData = cache.getCachedData("Discount Rate SUB ISO");
			int numberOfRows = cachedData.size();
			System.out.println("Total rows found: " + numberOfRows);
			...
			for (int currentRow = 1; currentRow <= numberOfRows; currentRow++) {
				...
				if (!channel.isEmpty()) {
					...
					testcaseCount++;
					logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : DiscountRate : Channel", channel, channelStatus, errorMessage);
				...
				if (!pricingPlan.isEmpty()) {
					...
					testcaseCount++;
					logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : DiscountRate : Pricing Plan", pricingPlan, networkStatus, errorMessage);
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : DiscountRate : Save Button", "SUB ISO Discount Rate", saveStatus, errorMessage);
			}
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : DiscountRate ","NextStep", nextStepStatus, errorMessage);
	...
	private void fillSettlementInfo(Map<String, String> testData, int TestcaseNo)
		...
		try {
			...
			if (channel != null && !channel.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Settlement Info : Settlement Channel", channel, Status, errorMessage);
			...
			if (Account != null && !Account.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Settlement Info : Settlement AccountType", Account, Status, errorMessage);
			...
			if (BanKAccountNumber != null && !BanKAccountNumber.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Settlement Info : BanKAccountNumber", BanKAccountNumber, Status, errorMessage);
			...
			if (IFSCCode != null && !IFSCCode.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Settlement Info : IFSC Code", IFSCCode, Status, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Save Button", "Settlement Info", SaveStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Settlement Info : ", "NextStep",  NextstepStatus, errorMessage);
	...
	private void configureWhiteLabel(Map<String, String> testData, int TestcaseNo)
		...
		String GM = testData.get("Group Merchant Onboarding");
		...
		try {
			...
			if (GM != null && !GM.trim().isEmpty()) {
				...
				try {
					...
					assertEquals(GM.toUpperCase(), BL.getElementText(B.WhitelabelISOOnboarding).toUpperCase());
					} catch (AssertionError e) {
					Status = false;
					errorMessage = e.getMessage(); // Capture error message
				}
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Whitelabel : Whitelabel Group Merchant Onboarding", GM, Status, errorMessage);
			}
			...
			if (Sales != null && !Sales.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Whitelabel : Whitelabel Sales Team Onboarding", Sales, Status, errorMessage);
			}
			...
			if (merchant != null && !merchant.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Whitelabel : Allow to create merchant onboard", merchant, Status, errorMessage);
			}
			...
			if (MaximumNoOfPlatform != null && !MaximumNoOfPlatform.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Whitelabel : Maximum No Of Platform", MaximumNoOfPlatform, Status, errorMessage);
			}
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Save Button", "Whitelabel", SaveStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Whitelabel : " , " NextStep ",  NextstepStatus, errorMessage);
	...
	private void configureWebhooks(Map<String, String> testData, int TestcaseNo) throws InterruptedException {
		...
		try {
			...
			if (type != null && !type.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Webhooks : Webhook Type", type, Status, errorMessage);
			}
			...
			if (webhookURL != null && !webhookURL.trim().isEmpty()) {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Webhooks : Webhook URL", webhookURL, Status, errorMessage);
			}
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Save Button", "Webhooks", SaveStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Webhooks : ", " NextStep ",  NextstepStatus, errorMessage);
	...
	private void submitForVerification(int TestcaseNo) throws InterruptedException {
		...
		try {
			...
			try {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Submit for Verification", "SUBISO", SaveStatus,
						errorMessage);
			...
			try {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : System Maker : Yes Button", "Submit for Verfication",
	...
	@Then("the System Verifier completes SUB ISO Onboarding, the system should prompt to verify all steps using the sheet name {string}")
	...
	private void Searchbyname(Map<String, String> testData, int TestcaseNo) throws InterruptedException, AWTException {
		...
		try {
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding :Actions and View", "SUB-ISO Status Inprogress", Status,
					errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "Sales Info", verifiedStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "Company Info", verifiedStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "Personal Info", verifiedStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "Communication Info", verifiedStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "Channel Config", verifiedStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "KYC-SUB ISO", verifiedStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "Discount Rate", verifiedStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "Settlement Info", verifiedStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "Whitelabel", verifiedStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Verified", "Webhooks", verifiedStatus, errorMessage);

			boolean SaveStatus = true;
			try {
				BL.clickElement(B.SubmitforApproval);

				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Submit for Approval", "Aggregator", SaveStatus,
						errorMessage);
			...
			try {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : System Verifier : Yes Button",
	...
	@Then("the System Approver completes SUB ISO Onboarding, the system should prompt to Approve using the sheet name {string}")
	...
	private void approveOnboarding(Map<String, String> testData, int TestcaseNo) throws InterruptedException {
		...
		try {
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Approval", "SUB-ISO", ApprovedStatus,
					errorMessage);
		...
		try {
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : System Approver : Yes", "Approval", ApprovedStatus,
					errorMessage);
			...
			try {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : System Approver : Sucess pop-up OK", "Approval", ApprovedStatus,
						errorMessage);
		...
		logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : SUB ISO CPID", BL.getElementValue(B.CPID), ApprovedStatus, errorMessage);
		BL.clickElement(B.ApproveCancel);
	...
	private void logTestStep(int testcaseCount, String fieldName, String fieldValue, Boolean status,
			String errorMessage) {
		String message = "SIO Test Case " + testcaseCount + ": " + fieldName + " with value '" + fieldValue + "' "
	...
	private void performLogout(int TestcaseNo) throws InterruptedException {
		...
		try {
			...
			try {
				...
				logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Profile & Log Out", "SUB-ISO", SaveStatus, errorMessage);
			...
			logTestStep(TestcaseNo, "MMS : SUB-ISO Onboarding : Yes Button", "Log-Out", SaveStatus, errorMessage);
